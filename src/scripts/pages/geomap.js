  ...
  async afterRender() {
    ...
    stories.forEach((story) => {
      if (story.lat && story.lon) {
        ...
        marker.bindPopup(`
          <b>${story.name}</b><br>
          //attribut alt ditambahkan pada <img>
          <img src="${story.photoUrl}" alt="Foto cerita: ${story.name}" width="150" style="border-radius:8px; margin-top:4px;"><br>
          ${story.description}
        `);
