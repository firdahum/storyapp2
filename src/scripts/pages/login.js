      ...
      <section class="container page-login">
        <div class="login-card">
          ...
          <p class="login-register-text">
            Belum punya akun? <a href="#/register" id="go-register">Daftar</a>
          </p>
        </div>
      </section>
    `;
  ...
  async afterRender() {
    ...
    form.addEventListener('submit', async (e) => {
      ...
      try {
        ...
        if (!result.error) {
          // simpan token login dengan kunci unik proyek baru
          localStorage.setItem('bt_token', result.loginResult.token);
          localStorage.setItem('bt_user', result.loginResult.name || email);
